      ...
      <nav className="fixed top-0 left-0 right-0 w-full z-50 px-6 py-8 flex justify-between items-center bg-transparent">
        ...
        <div className="flex items-center gap-6">
          ...
          <button 
            ...
            className="px-8 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full font-black uppercase tracking-widest text-xs shadow-[0_0_30px_rgba(79,70,229,0.3)] transition-all active:scale-95"
          >
            Start Journey
          </button>
        </div>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center text-center">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            ...
            <button 
              onClick={onLearnMore}
              className="px-8 py-5 rounded-full bg-white text-black font-black shadow-[0_0_30px_rgba(255,255,255,0.2)] hover:shadow-[0_0_40px_rgba(255,255,255,0.4)] transition-all relative overflow-hidden group active:scale-95"
            >
