...
const supabaseAnonKey = import.meta.env.VITE_SUPABASE_ANON_KEY || (typeof process !== 'undefined' ? process.env.VITE_SUPABASE_ANON_KEY : '') || import.meta.env.VITE_SUPABASE_PUBLISHABLE_DEFAULT_KEY || '';
